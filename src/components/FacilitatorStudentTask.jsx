        ...
        <div className="container px-5 mx-auto font-poppins mt-6 mb-20">
            ...
            <div className="sm:flex sm:items-center sm:justify-between mt-6">
                <div className="flex items-center gap-x-3">
                    {/* Student Title */}
                    <h1 className="text-3xl font-medium text-gray-900 dark:text-white">Juan Dela Cruz</h1>
                </div>
            </div>
                            ...
                            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <tbody className="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                                    ...
                                    <tr>
                                        ...
                                        <td className="px-4 py-4 text-sm font-medium text-gray-700 dark:text-gray-200 whitespace-nowrap">
                                            <div className="inline-flex items-center gap-x-3">
                                                ...
                                                <span className="flex items-center gap-x-2 ml-5">
                                                    {/* Date */}
                                                    <h2 className="text-sm font-medium text-gray-800 dark:text-white ">March 13, 2023</h2>
                                                </span>
                                            </div>
                                        </td>
                                        {/* STATUS */}
                                        ...
                                        {/* TIME IN */}
                                        <td className="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">08:00 AM</td>
                                        {/* TIME OUT */}
                                        <td className="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">05:00 PM</td>
                                        {/* TASKS */}
                                        ...
                                        {/* HOURS RENDERED */}
                                        <td className="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">16</td>
                                        {/* ACTION BUTTON */}
                                        <td className="px-4 py-4 text-sm whitespace-nowrap">
                                            <div className="flex items-center gap-x-3">
                                                {/* View Documentation Button */}
                                                <button className="flex items-center justify-center px-2.5 py-2.5 text-semibold text-sm transition-colors duration-200
                                                border-2 bg-white border-buttonBlue rounded-xl gap-x-2 sm:w-auto hover:text-white">
                                                    <svg class="h-5 w-5 text-buttonBlue"  width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  <path stroke="none" d="M0 0h24v24H0z"/>  <path d="M14 3v4a1 1 0 0 0 1 1h4" />  <path d="M17 21h-10a2 2 0 0 1 -2 -2v-14a2 2 0 0 1 2 -2h7l5 5v11a2 2 0 0 1 -2 2z" />  <path d="M9 15l2 2l4 -4" /></svg>
                                                    <span className='text-buttonBlue text-semibold pr-2'>
                                                        View File
                                                    </span>
                                                </button>
                                                {/* Approve Button */}
                                    ...
                                    <tr>
                                        ...
                                        <td className="px-4 py-4 text-sm font-medium text-gray-700 dark:text-gray-200 whitespace-nowrap">
                                            <div className="inline-flex items-center gap-x-3">
                                                ...
                                                <span className="flex items-center gap-x-2 ml-5">
                                                    {/* Date */}
                                                    <h2 className="text-sm font-medium text-gray-800 dark:text-white ">March 14, 2023</h2>
                                                </span>
                                            </div>
                                        </td>
                                        {/* STATUS */}
                                        ...
                                        <td className="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">200</td>
                                        {/* HOURS RENDERED */}
                                        <td className="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">24</td>
                                        {/* ACTION BUTTON */}
                                        <td className="px-4 py-4 text-sm whitespace-nowrap">
                                            <div className="flex items-center gap-x-3">
                                                {/* View Documentation Button */}
...
export default FacilitatorStudentTask