            ...
            <div className="sm:flex sm:items-center sm:justify-between mt-6">
                <div className="flex items-center gap-x-3">
                    ...
                    <h1 className="text-3xl font-medium text-gray-900 dark:text-white">
                        //INSERT CALENDAR ABOVE O NAH??
                        <br></br>
                        March 13, 2023</h1>
                </div>
            </div>

            {/* FILTERED VIEW FOR APPROVED, WAITING FOR APPROVAL */}
                                    ...
                                    <tr>
                                            ...
                                            <div className="inline-flex items-center gap-x-3">
                                                ...
                                                <span className="flex items-center gap-x-2 ml-5">
                                                    <div>
                                                        ...
                                                        {/* Student Course/Strand */}
                                                        <p className="text-xs font-normal text-gray-600 dark:text-gray-400">STEM</p>
                                                    </div>
                                                </span>
                                            </div>
                                        </td>
                                        ...
                                        <td className="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                            <div className="inline-flex items-center px-3 py-1 rounded-full gap-x-2 text-yellow-600 bg-yellow-100 dark:bg-gray-800">
                                                <h2 className="text-sm font-normal">Waiting Approval</h2>
                                            </div>
                                        </td>
                                        {/* TIME IN */}
...
export default FacilitatorStudentLogs2