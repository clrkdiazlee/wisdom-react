  ...
  return (
    <div>
        ...
        <div className="container px-5 mx-auto font-poppins mt-6 mb-20">
            ...
            {/* <div class="mt-4 mb-10 w-full grid grid-cols-1 md:grid-cols-3 xl:grid-cols-4 gap-4">
                <div class="bg-[#1B3996] shadow rounded-3xl p-4 sm:p-6 xl:p-8 ">
                    ...
                    <div class="flex-shrink-0">
                        <span class="text-lg sm:text-md leading-none font-semibold text-white">Student <br></br> Facilitators</span>
                    </div>
                ...
                <div class="bg-[#5CB8FF] shadow rounded-3xl p-4 sm:p-6 xl:p-8 ">
                    <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <span class="text-lg sm:text-md leading-none font-semibold text-white">Human <br></br> Resources</span>
                    </div>
                    <div class="ml-3 w-0 flex items-center justify-end flex-1 text-white text-6xl font-bold">
                        32
                    </div>
                ...
                <div class="bg-[#92C7FC] shadow rounded-3xl p-4 sm:p-6 xl:p-8 ">
                    <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <span class="text-lg sm:text-md leading-none font-semibold text-white">Registered <br></br> Schools</span>
                    </div>
                    <div class="ml-3 w-0 flex items-center justify-end flex-1 text-white text-6xl font-bold">
                        32
                    </div>
            ...
            <div class="mt-4 mb-10 w-full grid grid-cols-1 md:grid-cols-3 xl:grid-cols-4 gap-4">
                {/* Card 1 */}
                <div class="bg-white shadow rounded-3xl p-4 sm:p-6 xl:p-8 ">
                    <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <span class="text-lg sm:text-md leading-none font-semibold text-gray-900">Intern <br></br> Facilitators</span>
                    </div>
                    <div class="ml-3 w-0 flex items-center justify-end flex-1 text-gray-900 text-6xl font-bold">
                        5
                    </div>
                    </div>
                </div>
                ...
                <div class="bg-white shadow rounded-3xl p-4 sm:p-6 xl:p-8 ">
                    <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <span class="text-lg sm:text-md leading-none font-semibold text-gray-900">Human <br></br> Resources</span>
                    </div>
                    <div class="ml-3 w-0 flex items-center justify-end flex-1 text-gray-900 text-6xl font-bold">
                        10
                    </div>
                ...
                <div class="bg-white shadow rounded-3xl p-4 sm:p-6 xl:p-8 ">
                    <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <span class="text-lg sm:text-md leading-none font-semibold text-gray-900">Registered <br></br> Schools</span>
                    </div>
                    <div class="ml-3 w-0 flex items-center justify-end flex-1 text-gray-900 text-6xl font-bold">
                        6
                    </div>
                ...
                <div class="bg-white shadow rounded-3xl p-4 sm:p-6 xl:p-8 ">
                    <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <span class="text-lg sm:text-md leading-none font-semibold text-gray-900">Enrolled <br></br> Students</span>
                    </div>
                    <div class="ml-3 w-0 flex items-center justify-end flex-1 text-gray-900 text-6xl font-bold">
                        32
                    </div>
            ...
            {/* STUDENT TITLE AND STUDENT COUNT */}
            <div className="sm:flex sm:items-center sm:justify-between mt-6">
                <div className="flex items-center gap-x-3">
                    {/* Student Title */}
                    <h1 className="text-3xl font-medium text-gray-900 dark:text-white">Account Roles</h1>
                </div>
            </div>

            {/* SEARCH BAR, FILTERED VIEW FOR APPROVED, INCOMPLETE, AND PENDING */}
                            ...
                            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <tbody className="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                                    ...
                                    <tr>
                                        ...
                                        {/* EMAIL ADDRESS */}
                                        <td className="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">juandelacruz@example.com</td>
                                        {/* ROLE */}
                                        <td className="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                            <div className="inline-flex items-center px-3 py-1 rounded-full gap-x-2 text-emerald-500 bg-emerald-100/60 dark:bg-gray-800">
                                                <h2 className="text-sm font-normal">Student</h2>
                                            </div>
                                        </td>
                                        {/* ACTION BUTTON */}
                                    ...
                                    <tr>
                                        ...
                                        <td className="px-4 py-4 text-sm font-medium text-gray-700 dark:text-gray-200 whitespace-nowrap">
                                            <div className="inline-flex items-center gap-x-3">
                                                ...
                                                <span className="flex items-center gap-x-2 ml-5">
                                                    <div>
                                                        {/* Student Name */}
                                                        <h2 className="text-sm font-medium text-gray-800 dark:text-white ">Walter White</h2>
                                                    </div>
                                                </span>
                                            </div>
                                        </td>
                                        ...
                                        {/* EMAIL ADDRESS */}
                                        <td className="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">walterwhite@example.com</td>
                                        {/* ROLE */}
                                        <td className="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                            <div className="inline-flex items-center px-3 py-1 rounded-full gap-x-2 text-yellow-600 bg-yellow-100 dark:bg-gray-800">
                                                <h2 className="text-sm font-normal">School</h2>
                                            </div>
                                        </td>
                                        {/* ACTION BUTTON */}
                                        <td className="px-4 py-4 text-sm whitespace-nowrap">
