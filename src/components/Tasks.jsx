    ...
    <div className="antialiased bg-slate-200 text-slate-700 mx-2 font-poppins">
      ...
      <div className="max-w-lg mx-auto my-10 bg-white p-8 rounded-xl shadow shadow-slate-300">
        <div className="flex flex-row justify-between items-center">
          {/* ====================== TASK HEADER */}
          <div>
            <h1 class="text-3xl font-semibold !text-[#2F80ED]">Tasks</h1>
          </div>
          {/* ====================== TASK ACTION BUTTONS */}
          <div className="inline-flex space-x-2 items-center">
            {/* <a href="#" className="p-2 border border-slate-200 rounded-full inline-flex space-x-1 items-center text-indigo-200 hover:text-white bg-[#0017EB] hover:bg-[#0017EB]">
              ...
              <span class="text-sm font-medium hidden md:block px-1">Urgent</span>                     
            </a>
        ...
        <div id="tasks-in-progress" className="my-8">
          ...
          <div id="task" class="flex justify-between items-center border-b border-slate-200 py-3 px-2 border-l-4  border-l-transparent bg-gradient-to-r from-transparent to-transparent hover:from-slate-100 transition ease-linear duration-150">
            <div class="inline-flex items-center space-x-2">
              <div>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-slate-500 hover:text-[#0017EB] hover:cursor-pointer">
        ...
        <div id="tasks-completed" className="my-8">
          ...
          <div id="task" class="flex justify-between items-center border-b border-slate-200 py-3 px-2 border-l-4  border-l-transparent">
            <div className="inline-flex items-center space-x-2">
              <div>
                <svg xmlns="http://www.w3.org/2000/svg" fill="#64748B" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-7 h-7 text-white hover:cursor-pointer">
                <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <div class="text-slate-500 line-through">Revise document proposal</div>
            </div>
              {/* ====================== TRASH ICON */}
            <div>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 text-red-500 hover:text-slate-700 hover:cursor-pointer">
        ...
        <button
          type="button"
          class="mb-2 block w-full rounded-full bg-[#0017EB] px-6 pt-2.5 pb-2 text-lg font-medium leading-normal text-white transition duration-150 ease-in-out hover:bg-[#000e91] focus:bg-primary-600 focus:outline-none focus:ring-0 active:bg-primary-700">
          Add New Task
        </button>
      </div>
      {/*  */}
